...
| `RENEWAL_INTERVAL`     | Интервал между проверками обновления сертификата. Установить в 0 чтобы отключить автоматическое продления и запустить только один раз.                          | 43200 секунд (12 часов) |
